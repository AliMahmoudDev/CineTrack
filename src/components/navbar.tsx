...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-black/60 border-b border-zinc-800/50">
      ...
      {/* mobile nav dropdown */}
      {mobileOpen && (
        <div className="md:hidden border-t border-zinc-800/50 bg-black/80 backdrop-blur-md">
